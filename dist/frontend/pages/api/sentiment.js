...
var inferTweetSentiment = function (tweets) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('https://api-inference.huggingface.co/models/cardiffnlp/twitter-roberta-base-sentiment', {
                        headers: {
...
var getSentiment = function (query, onSuccess) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getRecentTweets(query, 3)];
            case 1:
                tweets = _b.sent();
...
function handler(req, res) {
    if (req.method === 'GET') {
        ...
        getSentiment(req.body.query, function (data) {
